                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card border-left-primary shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-0">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Active Membership</div>
                ...
                <!-- Customer record -->
                    <div class="col-md-12 mb-3">
                        <div class="card border-left-pink shadow h-100 py-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-0">
                                <div class="text-xs font-weight-bold text-pink text-uppercase mb-1">Active Membership</div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <?php 
                                    $query = "SELECT COUNT(*) FROM customer";
                                    $result = mysqli_query($db, $query) or die(mysqli_error($db));
